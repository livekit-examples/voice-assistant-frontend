    ...
    <SelectPrimitive.Trigger
      ...
      className={cn(
        [
          ...
          'border-button-border bg-button rounded-md border px-3 py-2 text-sm whitespace-nowrap',
          'transition-[color,border,background-color]',
          'disabled:cursor-not-allowed disabled:opacity-50',
          'hover:bg-background focus-visible:border-ring focus-visible:ring-ring/50 outline-none focus-visible:ring-[3px]',
